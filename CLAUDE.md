...
- **Loop prompt craft (on top of normal LTX rules):**
  ...
  2b. **Aesthetic clauses override motion verbs (Run 4 lesson, 2026-07-07).** A pastel-beauty batch with vivid verbs BUT "soft dreamy delicate gentle premium glow" styling came out near-still (motion 0.02–1.11) — those words cue slow spa footage. In loop prompts NEVER use gently/gentle/dreamy/delicate/slowly/soft glow; style with "crisp studio light, bold aesthetic, rich saturated color" instead. Also prefer hot-pink/magenta-grade contrast on deeper grounds over pale-on-white — low-contrast pastels both move less and under-measure on the motion check.
